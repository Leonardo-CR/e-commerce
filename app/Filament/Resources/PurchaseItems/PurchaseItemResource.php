...
class PurchaseItemResource extends Resource
{
    ...
    protected static ?string $modelLabel = 'Artículo de compra';

    protected static ?string $pluralModelLabel = 'Artículos de compra';

    protected static ?string $navigationLabel = 'Artículos de compra';
